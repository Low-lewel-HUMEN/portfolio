...
* opened `file1.txt` and created or changed `file2.txt` (if `file1.txt` not found - program do `ExitProcess(1)` through WinAPI);
...
```
* Open `build.bat` from folder `"main \ c-works \ study \ work-with-files \ work-18.03.2026"`
